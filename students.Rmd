...
- **Bethany Bateman-McDonald** (PhD, Romance Language), Dissertation Title: *Contact-induced subjectivization in the compound past: an examination of PP/PRET variation in Cusco Spanish* (2022)
...
- **Madeline Critchfield** (PhD, Romance Languages), Dissertation Title: *A Tale of Two Coasts: The Impact of Language Contact on Number Marking and Subject Pronoun Expression in Two Varieties of Spanish in Nicaragua* (2021, [Assistant Professor at Rockhurst University](https://www.rockhurst.edu/directory/faculty/madeline-critchfield))
- **Dallin V. Larsen**, Dissertation Title: *A corpus based approach to the diachrony of the Spanish discourse markers* bien, bueno, *and* claro (2020, [Spanish Lecturer at Rollins College](https://www.rollins.edu/global-languages/faculty-staff/)) [[link](https://esploro.libs.uga.edu/esploro/outputs/9949365848702959)]
...
- **Philip Limerick** (PhD, Romance Languages), Dissertation Title: [*Subject expression in a Southeastern U.S. Mexican Community*](https://getd.libs.uga.edu/pdfs/limerick_philip_p_201812_phd.pdf) (2018, [Visiting Assistant Professor of Spanish at Centre College](https://www.centre.edu/directory/name/philip-limerick/))
- **Shannon McDonough** (MA, Romance Languages), Thesis Title: [*La gramaticalización de la estructura* (NO) IMPORTAR + MINIMIZADOR; *La negación y las palabras tabúes en español*](https://getd.libs.uga.edu/pdfs/mcdonough_shannon_r_201808_ma.pdf) (2018, English Language Development Teacher at Academies of Math and Science)
